...
SoftwareSerial A9GSerial(RXPin, TXPin); // RX, TX
...
bool sendDataToServer(float latitude, float longitude ) {
    String serverURL = ""; 
    String plateNumber = "xx";
    // Create JSON data
    String jsonData = "{\"latitude\":" + String(latitude, 8) + ", \"longitude\":" + String(longitude, 8) + ", \"plateNumber\":" + plateNumber + "}";
